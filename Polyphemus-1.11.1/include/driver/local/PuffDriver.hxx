...
#ifndef POLYPHEMUS_FILE_DRIVER_PUFFDRIVER_HXX
...
namespace Polyphemus
{
  ...
  /*! \brief This class provides a driver for a Gaussian puff model that is
  ...
  */
  /*! The driver is responsible for the model initialization, for the loop
    ...
    calls to the output saver. Its reference floating-point precision is
    'T'. The model is an instance of 'ClassModel' and the output saver is an
...
#define POLYPHEMUS_FILE_DRIVER_PUFFDRIVER_HXX
#endif
