...
#ifndef POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITDOMAIN_HXX
...
namespace Polyphemus
{
  ...
  class SaverUnitDomain: public BaseSaverUnit<T, ClassModel>
  {

  protected:

    //! Type of saver ("domain" or "domain_ensemble").
    string type;
    //! Ensemble mode?
    bool with_ensemble;
    ...
    //! Date at which the previous call to method 'Save' has been performed.
    Date previous_date;

    //! Model number (for ensembles).
    int Nmodel;
    //! Total number of initial calls.
    int Ncall;
...
#define POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITDOMAIN_HXX
#endif
