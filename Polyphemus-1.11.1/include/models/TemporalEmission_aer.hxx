...
#ifndef POLYPHEMUS_FILE_MODELS_TEMPORALEMISSION_AER_HXX
...
namespace Polyphemus
{
  ...
  template<class T>
  class TemporalEmission_aer: public TemporalEmission<T>
  {
  ...
  public:
    ...
    void GetEmission_aer(Date date_beg, Date date_end, int s,
                         T& quantity);
  };
...
#define POLYPHEMUS_FILE_MODELS_TEMPORALEMISSION_AER_HXX
#endif
