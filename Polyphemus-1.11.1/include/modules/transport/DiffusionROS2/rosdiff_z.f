...
C-----------------------------------------------------------------------
      ...
      SUBROUTINE rosdiff_z (Nz,DLconc,
...
C     div(K_z \partial_z c).
      CALL fexdiff_z (Nz,DLconc,DLb1,Dkz,Zdm,Zdc,
     $     Dcdep,Dcemis,rhoz)

C     Jacobian matrix.
      CALL jacddiffdc_z (Nz,DLdz,DLdzu,DLdzl,Dkz,Zdm,Zdc,Dcdep,rhoz)
...
C     2 - Compute K2
      ...
      CALL fexdiff_z (Nz,DLconcbis,DLb2,Dkzf,Zdm,Zdc,
     $     Dcdepf,Dcemisf,rhoz)
