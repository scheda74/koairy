...
C-----------------------------------------------------------------------
      ...
      SUBROUTINE GLOBAL_ADVECTION(Nx, Ny, Nz, Dmx, Dmy, Dmz, U, V, W,
     $     CLESP, Zclx, Zcly, Zclz, dt, C)
               ...
               ELSE
                  ...
                  IF (wind.GE.0.D0) THEN
                     ...
                     ELSE
                        C_0 = C(Ji-2,Jj,Jk)
                     ENDIF
                     CALL global_numerical_flux(nu_m, C_0, C_1, C_2,
     $                    Fx_0)

                     IF (nu_p .NE. nu_m) THEN
                        CALL global_numerical_flux(nu_p, C_0, C_1, C_2,
     $                       Fx_1)
                     ELSE
                        Fx_1 = Fx_0
                     ENDIF
                  ...
                  ELSE
                     ...
                     CALL global_numerical_flux(-nu_m, C_3, C_2, C_1,
     $                    Fx_0)

                     IF (nu_p .NE. nu_m) THEN
                        CALL global_numerical_flux(-nu_p, C_3, C_2, C_1,
     $                       Fx_1)
                     ELSE
                        Fx_1 = Fx_0
                     ENDIF
