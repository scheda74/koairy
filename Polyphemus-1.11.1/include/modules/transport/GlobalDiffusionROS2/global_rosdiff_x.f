...
C-----------------------------------------------------------------------
      ...
      SUBROUTINE global_rosdiff_x (Nx,Dcx,Dmx,DLmatxl,DLmatx,DLmatxu
     $     ,DLkx,rhox,DLconc,ts,tf,LITERDIFFX)
...
C     div(K_x \partial_x c).
      CALL global_fexdiff_x (Nx,Dcx,Dmx,DLconc,DLkx,rhox,DLb1)

      IF (LITERDIFFX) THEN

C     Jacobian matrix.
         CALL global_jacddiffdc_x(Nx,Dcx,Dmx,DLkx,rhox,DLdxl,DLdx,DLdxu)
      ...
      CALL global_solvtridiag_x (Nx,DLmatxl,DLmatx,DLmatxu,DLk1,DLb1)
...
C     2 - Compute K2
      ...
      CALL global_fexdiff_x (Nx,Dcx,Dmx,DLconcbis,DLkx,rhox,DLb2)

      DO Ji=1,Nx
         DLb2(Ji) =  DLb2(Ji)-2.D0*DLk1(Ji)
      ENDDO

      CALL global_solvtridiag_x (Nx,DLmatxl,DLmatx,DLmatxu,DLk2,DLb2)
