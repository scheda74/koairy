...
Module jAdaptstep
  ...
  use kSOAP
   implicit none
contains
  subroutine aerodyn(start_time,end_time,psoap_config, psurrogate)
!------------------------------------------------------------------------
!
!     -- DESCRIPTION
...
!       call check_nan_inf(6)
	...
	call  processaero(solver,lwc_Nsize,ionic_Nsize,proton_Nsize,liquid_Nsize)
...
!
         call SOAP_DYN(Relative_Humidity,&
              ...
              Temperature, psoap_config, psurrogate,timestep_cond,&
...
!	call update_wet_diameter_liquid(1,N_size,concentration_mass, concentration_number,wet_mass,wet_diameter,wet_volume,cell_diam_av)
  ...
  subroutine processaero(solver,lwc_Nsize,ionic_Nsize,proton_Nsize,liquid_Nsize)
!------------------------------------------------------------------------
!
!     -- DESCRIPTION
...
!     Coagulation time step.
    ...
    if (with_coag.eq.1) then
      ...
      tag_cond=0
      tag_nucl=0
      call fgde(c_mass,c_number,c_gas,dqdt1,dndt1,ce_kernal_coef,lwc_Nsize,ionic_Nsize, &
...
!!!     ******compute new time step
  ...
  subroutine Etr_solver(q1,q2,n1,n2,c_gas,dqdt,lwc_Nsize,ionic_Nsize,proton_Nsize,liquid_Nsize)
!------------------------------------------------------------------------
!
!     -- DESCRIPTION
...
!------------------------------------------------------------------------
  ...
  subroutine Euler_solver(c_mass,c_number,c_gas,dqdt,lwc_Nsize,ionic_Nsize,proton_Nsize,liquid_Nsize)
!------------------------------------------------------------------------
!
!     -- DESCRIPTION
!     This subroutine solves a system of Ordinary Differential Equations
...
!------------------------------------------------------------------------
  ...
  subroutine Ros2_solver(q1,q2,n1,n2,c_gas,dqdt,lwc_Nsize,ionic_Nsize,proton_Nsize,liquid_Nsize)
!------------------------------------------------------------------------
!
!     -- DESCRIPTION
...
!------------------------------------------------------------------------
    ...
    double precision:: proton_Nsize(N_size),liquid_Nsize(12,N_size)
  !for condensation
    call fgde(q2,n2,c_gas,k1,dn1dt,ce_kernal_coef,lwc_Nsize,ionic_Nsize, &
