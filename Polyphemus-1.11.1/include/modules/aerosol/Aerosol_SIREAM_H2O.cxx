// Copyright (C) 2007-2013, ENPC - INRIA - EDF R&D
...
#ifndef POLYPHEMUS_FILE_MODULES_AEROSOL_AEROSOL_SIREAM_AEC_CXX

#include "Aerosol_SIREAM_H2O.hxx"
...
namespace Polyphemus
{
  ...
  //! Default constructor.
  template<class T>
  Aerosol_SIREAM_AEC<T>::Aerosol_SIREAM_AEC()
  {
  ...
  */
  ...
  template<class T>
  template<class ClassModel>
  void Aerosol_SIREAM_AEC<T>::DisplayConfiguration(ClassModel& Model)
  {
  ...
  */
  template<class T>
  template<class ClassModel>
  void Aerosol_SIREAM_AEC<T>::Forward(ClassModel& Model)
  {
  ...
  */
  template<class T>
  template<class ClassModel>
  void Aerosol_SIREAM_AEC<T>::Forward_aer(ClassModel& Model)
  {
    Date date_i = Model.GetCurrentDate();
    Date date_f = Model.GetNextDate();
  ...
  template<class T>
  void Aerosol_SIREAM_AEC<T>::Forward(T current_time,
...
#pragma omp parallel for num_threads(Nthreads_openmp)	\
  ...
  */
  template<class T>
  void Aerosol_SIREAM_AEC<T>::Forward_aer(T current_time,
					  Data<T, 3>& SpecificHumidity_i,
					  Data<T, 3>& Temperature_i,
					  Data<T, 3>& Pressure_i,
					  T delta_t,
...
#pragma omp parallel for num_threads(Nthreads_openmp)	\
  ...
  */
  template<class T>
  bool Aerosol_SIREAM_AEC<T>::IsRequired(string field)
  {
  ...
  */
  template<class T>
  bool Aerosol_SIREAM_AEC<T>::IsComputed(string field)
  {
  ...
  template<class T>
  void Aerosol_SIREAM_AEC<T>::FogSettling(Array<T, 1>& LiquidWaterContent,
...
#define POLYPHEMUS_FILE_MODULES_AEROSOL_AEROSOL_SIREAM_AEC_CXX
#endif
