...
#ifndef POLYPHEMUS_FILE_MODULES_AEROSOL_AEROSOL_SCRAM_SOAP_HXX
...
#define _dimensions dimensions_
  ...
  extern "C"
  {
    ...
    void __zaerosolscram_MOD_aerosol(int*, int*, int*, int*,
                                     ...
                                     model_config*, vector<species>*, double*,
                                     double*);
  ...
  //! RACM_SCRAM_SOAP, CB05_SCRAM_SOAP and RACM2_SCRAM_SOAP.
  /*! It uses a second-order Rosenbrock method.
   */
  template<class T>
  class Aerosol_SCRAM_SOAP: public BaseModuleParallel
  {
  ...
  public:
    ...
    */
    ...
    int coef_size;
    Array<int, 1> Ncoefficient;
    Array<int, 1> index_first;
    Array<int, 1> index_second;
    Array<double, 1> coefficient;
...
#define POLYPHEMUS_FILE_MODULES_AEROSOL_AEROSOL_SCRAM_SOAP_HXX
#endif
