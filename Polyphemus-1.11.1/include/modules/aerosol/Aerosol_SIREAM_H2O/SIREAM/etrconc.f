...
C-----------------------------------------------------------------------
      ...
      SUBROUTINE ETRCONC(neq,nesp_aer,nbin_aer,q1,q,iq,couples_coag,
...
C     First step
      CALL FGDE(neq,nesp_aer,nbin_aer,q,iq,dq1dt,couples_coag,
     s     first_index_coag,second_index_coag,
...
C     Second step
      ...
      CALL FGDE(neq,nesp_aer,nbin_aer,q1,iq,dq2dt,couples_coag,
     s     first_index_coag,second_index_coag,
     s     coefficient_coag,QT,XSF,MSF,DSF,XSD,MSD,DSD,AA,
     s     bin_density)
