...
#ifndef POLYPHEMUS_FILE_MODULES_AEROSOL_AEROSOL_SIREAM_AEC_HXX
...
#define _dimensions dimensions_
  ...
  //! RACM_SIREAM_AEC, CB05_SIREAM_AEC and RACM2_SIREAM_AEC.
  /*! It uses a second-order Rosenbrock method.
   */
  template<class T>
  class Aerosol_SIREAM_AEC: public BaseModuleParallel
  {
...
#define POLYPHEMUS_FILE_MODULES_AEROSOL_AEROSOL_SIREAM_AEC_HXX
#endif
