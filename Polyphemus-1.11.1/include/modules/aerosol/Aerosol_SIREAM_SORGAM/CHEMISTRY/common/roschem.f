...
C-----------------------------------------------------------------------
      ...
      SUBROUTINE roschem (NS,Nr,nemis,DLconc,
     s     ZCsourc,ZCsourcf,convers_factor,convers_factor_jac,
...
C
C
C     2010/02/18(YK): Variable names correction
C                     ngas or nesp -> ns
...
C     PARACHEM: parameters for sizes of 'chemical' arrays.
      ...
      double precision convers_factor(ns), convers_factor_jac(ns,ns)
