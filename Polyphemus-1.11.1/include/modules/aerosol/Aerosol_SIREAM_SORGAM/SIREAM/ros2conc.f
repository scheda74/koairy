...
C-----------------------------------------------------------------------
      ...
      SUBROUTINE ROS2CONC(neq,nbin_aer,q1,q,iq,couples_coag,
...
C     ****** and the approximation of jacobian's diagional.
      ...
      CALL FGDE(neq,nbin_aer,q,iq,k1,couples_coag,
     s      first_index_coag,second_index_coag,
...
C     ******2. first evaluation
      ...
      CALL KLIMIT(neq,nbin_aer,q,iq,k1,AA)
      DO j = 1 , neq
...
C     ******&  the approximation of jacobian's diagonal
      ...
      TIN2 = TIN2 + DT2
      CALL FGDE(neq,nbin_aer,q1,iq,k2,couples_coag,
     s      first_index_coag,second_index_coag,
     s      coefficient_coag,QT,XSF,MSF,DSF,XSD,MSD,DSD,AA)
...
C     ******4. second evaluation
     ...
     &        / (1.d0      - Gamma*        Jd1(j) *DT2  )
      ...
      CALL KLIMIT(neq,nbin_aer,q,iq,k2,AA)
      DO j = 1 , neq
