...
C-----------------------------------------------------------------------
      ...
      SUBROUTINE FGDE(neq,nbin_aer,q,iq,dqdt,couples_coag,
...
C     Compute the physical processes
      ...
      IF (ICG2.EQ.1) CALL FCOAG(neq,nbin_aer,q,iq,dqdt,couples_coag,
     s      first_index_coag,second_index_coag,coefficient_coag,QT,
     s      XSF,MSF,DSF,XSD,MSD,DSD)

      IF (ICE2.EQ.1) CALL FCOND(neq,nbin_aer,q,iq,dqdt,QT,
