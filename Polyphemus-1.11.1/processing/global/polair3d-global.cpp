...
#include "GlobalAdvectionDST3.cxx"
#include "GlobalDiffusionROS2.cxx"
...
int main(int argc, char** argv)
{
  ...
  typedef double real;
  typedef Polair3DTransport < real, GlobalAdvectionDST3<real>,
                              GlobalDiffusionROS2<real> > ClassModel;
