...
#include "CastorChemistry.cxx"
#include "TransportPPM.cxx"
#include "ChemistryCastor.cxx"
...
int main(int argc, char** argv)
{
  ...
  typedef double real;
  typedef CastorChemistry < real, TransportPPM<real>,
                            ChemistryCastor<real> > ClassModel;
